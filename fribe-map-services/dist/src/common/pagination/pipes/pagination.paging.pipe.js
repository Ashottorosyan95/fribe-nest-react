...
function PaginationPagingPipe(defaultPerPage) {
    let MixinPaginationPagingPipe = class MixinPaginationPagingPipe {
        ...
        async transform(value) {
            ...
            let updatedPerPage = value?.perPage > 50 ? 50 : value?.perPage;
            const perPage = this.paginationService.perPage(this.helperNumberService.create(updatedPerPage ?? defaultPerPage));
