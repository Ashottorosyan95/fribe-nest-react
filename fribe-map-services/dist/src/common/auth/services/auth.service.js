...
let AuthService = exports.AuthService = class AuthService {
    constructor(helperHashService, helperDateService, helperStringService, helperEncryptionService, configService, redisService) {
        ...
        this.authServiceUrl = this.configService.get('auth.authServiceUrl');
