...
export class UserService implements IUserService {
    ...
    async findOneByUsername<T>(
        ...
        // this.loggerService.info({this.request.})
    ...
    async findOneByPublishableKey<T>(
        publishableKey: string,
        options?: IDatabaseFindOneOptions
    ): Promise<T> {
        return this.userRepository.findOne<T>({ publishableKey }, options);
    }

    async findOneByClientId<T>(
        clientId: string,
        options?: IDatabaseFindOneOptions
    ): Promise<T> {
        return this.userRepository.findOne<T>({ clientId }, options);
    }
    ...
    async updateUsageCount(
        ...
        repository.subscribedPlan = {
            ...repository.subscribedPlan,
            services: repository.subscribedPlan.services.map((obj: any) => {
