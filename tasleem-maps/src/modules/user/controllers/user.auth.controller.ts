...
import { ResponseApiKeysSerialization } from 'src/common/response/serializations/response.api.serialization';
...
export class UserAuthController {
    ...
    @UserAuthApiKeysDoc()
    @Response('user.apiKeys', { serialization: ResponseApiKeysSerialization })
    // @AuthJwtAccessProtected()
    @Get('/api-keys/:accesstoken')
    async apiKeys(@Param('accesstoken') accesstoken: string): Promise<IResponse> {
    ...
    @UserProtected()
    @AuthJwtAccessProtected()
    @Response('user.regenerateApiKey')
    @HttpCode(HttpStatus.OK)
    ...
    async regenerateApiKey(
        ...
        try {
            ...
            const hash: string = await this.apiKeyService.createHashApiKey(key, secret);
