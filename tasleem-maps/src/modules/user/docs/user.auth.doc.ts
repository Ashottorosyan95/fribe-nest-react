...
export function UserRegenerateApiKeyDoc(): MethodDecorator {
    return applyDecorators(
        Doc<void>('user.regenerateApiKey', {
            auth: {
                jwtAccessToken: true,
            }
        })
...
export function UserAuthApiKeysDoc(): MethodDecorator {
    return applyDecorators(
        Doc<ResponseApiKeysSerialization>('user.apiKeys', {
            auth: {
                jwtAccessToken: true,
            },
            response: {
                serialization: ResponseApiKeysSerialization,
            },
        })
    );
}
