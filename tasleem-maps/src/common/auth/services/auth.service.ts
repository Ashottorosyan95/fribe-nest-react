...
export class AuthService implements IAuthService {
  ...
  async validatePublishableKey(publishableKey: string, serviceType: ENUM_SERVICE): Promise<object> {
    const user: UserDoc = await this.userService.findOneByPublishableKey(publishableKey);
