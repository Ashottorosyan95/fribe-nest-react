...
export declare class AuthService implements IAuthService {
    ...
    constructor(helperHashService: HelperHashService, helperDateService: HelperDateService, helperStringService: HelperStringService, helperEncryptionService: HelperEncryptionService, userService: UserService, configService: ConfigService, redisService: RedisService);
    ...
    validatePublishableKey(publishableKey: string, serviceType: ENUM_SERVICE): Promise<object>;
