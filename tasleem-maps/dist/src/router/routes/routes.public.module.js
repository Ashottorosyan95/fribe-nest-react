...
exports.RoutesPublicModule = RoutesPublicModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [],
        exports: [],
        imports: [terminus_1.TerminusModule, health_module_1.HealthModule, user_module_1.UserModule, auth_module_1.AuthModule, role_module_1.RoleModule, api_key_module_1.ApiKeyModule],
    })
], RoutesPublicModule);
