...
export declare class UserPublicController {
    ...
    constructor(databaseConnection: Connection, userService: UserService, authService: AuthService, roleService: RoleService, settingService: SettingService, apiKeyService: ApiKeyService);
    validatePublishableKey({ publishableKey, serviceType }: UserValidatePublishableKeyDto): Promise<any>;
    login({ email, password, role }: UserLoginDto): Promise<IResponse>;
    signUp({ email, mobileNumber, ...body }: UserSignUpDto): Promise<IResponse>;
