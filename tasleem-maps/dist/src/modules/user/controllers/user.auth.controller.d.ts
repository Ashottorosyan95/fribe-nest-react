...
export declare class UserAuthController {
    ...
    constructor(userService: UserService, authService: AuthService, settingService: SettingService, awsS3Service: AwsS3Service, apiKeyService: ApiKeyService);
    ...
    apiKeys(accesstoken: string): Promise<IResponse>;
    ...
    regenerateApiKey(user: UserDoc): Promise<void>;
