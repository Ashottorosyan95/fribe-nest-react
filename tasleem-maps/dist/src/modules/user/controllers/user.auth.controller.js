...
const response_api_serialization_1 = require("../../../common/response/serializations/response.api.serialization");
let UserAuthController = exports.UserAuthController = class UserAuthController {
    constructor(userService, authService, settingService, awsS3Service, apiKeyService) {
    ...
    async apiKeys(accesstoken) {
        const userInfo = await this.authService.payloadAccessToken(accesstoken);
        return { data: { secretKey: userInfo.data.apiKey, publishableKey: userInfo.data.publishableKey } };
    }
    async info(payload) {
        return { data: payload };
    }
    ...
    async regenerateApiKey(user) {
        try {
            const key = await this.apiKeyService.createKey();
            const secret = await this.apiKeyService.createSecret();
            const hash = await this.apiKeyService.createHashApiKey(key, secret);
            await this.userService.regenerateApiKey(user, hash);
        }
        catch (err) {
            throw new common_1.InternalServerErrorException({
                statusCode: error_status_code_constant_1.ENUM_ERROR_STATUS_CODE_ERROR.ERROR_UNKNOWN,
...
__decorate([
    (0, user_auth_doc_1.UserAuthApiKeysDoc)(),
    (0, response_decorator_1.Response)('user.apiKeys', { serialization: response_api_serialization_1.ResponseApiKeysSerialization }),
    (0, common_1.Get)('/api-keys/:accesstoken'),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, common_1.Param)('accesstoken')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UserAuthController.prototype, "apiKeys", null);
__decorate([
...
__decorate([
    (0, user_auth_doc_1.UserRegenerateApiKeyDoc)(),
    (0, user_decorator_1.UserProtected)(),
    (0, auth_jwt_decorator_1.AuthJwtAccessProtected)(),
    (0, response_decorator_1.Response)('user.regenerateApiKey'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, common_1.Patch)('/regenerate-apikey'),
    openapi.ApiResponse({ status: common_1.HttpStatus.OK }),
    __param(0, (0, user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserAuthController.prototype, "regenerateApiKey", null);
__decorate([
