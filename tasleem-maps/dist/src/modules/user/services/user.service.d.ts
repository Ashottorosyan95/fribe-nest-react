...
export declare class UserService implements IUserService {
    ...
    constructor(userRepository: UserRepository, helperDateService: HelperDateService, helperStringService: HelperStringService, configService: ConfigService, loggerService: LoggerService, request: Request);
    ...
    findOneByPublishableKey<T>(publishableKey: string, options?: IDatabaseFindOneOptions): Promise<T>;
    findOneByClientId<T>(clientId: string, options?: IDatabaseFindOneOptions): Promise<T>;
    ...
    create({ firstName, lastName, email, mobileNumber, companyName, role, shortId, clientId, publishableKey, apiKey, signUpFrom, }: UserCreateDto, { passwordExpired, passwordHash, salt, passwordCreated }: IAuthPassword, options?: IDatabaseCreateOptions): Promise<UserDoc>;
    ...
    updateUsageCount(repository: UserDoc, { serviceType }: any, options?: IDatabaseSaveOptions): Promise<any>;
    ...
    regenerateApiKey(repository: UserDoc, apiKey: string): Promise<UserDoc>;
