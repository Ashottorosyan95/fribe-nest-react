...
let UserService = exports.UserService = class UserService {
    constructor(userRepository, helperDateService, helperStringService, configService, loggerService, request) {
    ...
    async findOneByPublishableKey(publishableKey, options) {
        return this.userRepository.findOne({ publishableKey }, options);
    }
    async findOneByClientId(clientId, options) {
        return this.userRepository.findOne({ clientId }, options);
    }
    ...
    async create({ firstName, lastName, email, mobileNumber, companyName, role, shortId, clientId, publishableKey, apiKey, signUpFrom, }, { passwordExpired, passwordHash, salt, passwordCreated }, options) {
        ...
        create.publishableKey = publishableKey;
    ...
    async updateUsageCount(repository, { serviceType }, options) {
        repository.subscribedPlan = {
            ...repository.subscribedPlan,
            services: repository.subscribedPlan.services.map((obj) => {
                if (serviceType === obj.serviceType) {
    ...
    async regenerateApiKey(repository, apiKey) {
