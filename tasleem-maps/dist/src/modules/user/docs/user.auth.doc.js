...
exports.UserAuthChangePasswordDoc = exports.UserAuthApiKeysDoc = exports.UserAuthInfoDoc = exports.UserAuthUploadProfileDoc = exports.UserRegenerateApiKeyDoc = exports.UserAuthProfileDoc = exports.UserAuthRefreshDoc = void 0;
...
function UserRegenerateApiKeyDoc() {
    return (0, common_1.applyDecorators)((0, doc_decorator_1.Doc)('user.regenerateApiKey', {
        auth: {
            jwtAccessToken: true,
        }
    }));
}
exports.UserRegenerateApiKeyDoc = UserRegenerateApiKeyDoc;
...
function UserAuthApiKeysDoc() {
    return (0, common_1.applyDecorators)((0, doc_decorator_1.Doc)('user.apiKeys', {
        auth: {
            jwtAccessToken: true,
        },
        response: {
            serialization: response_api_serialization_1.ResponseApiKeysSerialization,
        },
    }));
}
exports.UserAuthApiKeysDoc = UserAuthApiKeysDoc;
