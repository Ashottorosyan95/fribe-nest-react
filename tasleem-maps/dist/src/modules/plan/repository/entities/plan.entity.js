...
let PlanEntity = exports.PlanEntity = class PlanEntity extends database_mongo_uuid_entity_abstract_1.DatabaseMongoUUIDEntityAbstract {
    static _OPENAPI_METADATA_FACTORY() {
        return { shortId: { required: true, type: () => String }, name: { required: true, type: () => String }, price: { required: true, type: () => Number }, services: { required: true, type: () => [String] }, requestLimit: { required: true, type: () => Number }, timeWindow: { required: true, enum: require("../../constants/plan.time-window.constant").ENUM_PLAN_TIME_WINDOW } };
    }
};
__decorate([
    (0, mongoose_1.Prop)({
