...
let PlanRepository = exports.PlanRepository = class PlanRepository extends database_mongo_uuid_repository_abstract_1.DatabaseMongoUUIDRepositoryAbstract {
...
exports.PlanRepository = PlanRepository = __decorate([
    ...
    __param(0, (0, database_decorator_1.DatabaseModel)(plan_entity_1.PlanEntity.name)),
