...
class PlanCreateDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, maxLength: 100 }, price: { required: true, type: () => Number }, services: { required: true, type: () => [String] }, requestLimit: { required: true, type: () => Number }, timeWindow: { required: true, enum: require("../constants/plan.time-window.constant").ENUM_PLAN_TIME_WINDOW } };
    }
}
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => Number),
    __metadata("design:type", Number)
], PlanCreateDto.prototype, "requestLimit", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
        required: true,
    }),
    ...
    (0, class_transformer_1.Type)(() => String),
    __metadata("design:type", String)
], PlanCreateDto.prototype, "timeWindow", void 0);
